...
class Catalog:
    ...
    def load(self, catalog_path, top_tracks_path, tracks_with_diverse_recs_path,
             context_embeddings_path, track_embeddings_path, user_embeddings_path):
        ...
        self.context_embeddings = np.load(context_embeddings_path)
        self.user_embeddings = np.load(user_embeddings_path)
        self.track_embeddings = np.load(track_embeddings_path)
